...
mod tests {
    ...
    fn new_reset_dac() {
        ...
        assert_eq!(instr.to_bytevec(),
            &[0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0x00,
    ...
    fn new_set_dac_with_regs() {
        ...
        assert_eq!(instr.to_bytevec(),
            &[0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00,
              0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x80, 0x00,
    ...
    fn new_update_channel_with_regs() {
        ...
        assert_eq!(instr.to_bytevec(),
            &[0x00, 0x00, 0x00, 0x40, 0x73, 0x40, 0x00, 0x00, 0x92, 0x49, 0x24,
              0x92, 0x49, 0x24, 0x92, 0x49, 0x24, 0x92, 0x49, 0x24, 0x92, 0x49,
              0x24, 0x92, 0x49, 0x24, 0x92, 0x49, 0x24, 0x92, 0x49, 0x24, 0x80,
              0x00, 0x80, 0x00]);
    }
    ...
    fn new_update_logic() {
        ...
        assert_eq!(instr.to_bytevec(),
            &[0x00, 0x00, 0x00, 0x20, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00,
    ...
    fn new_current_read() {
        ...
        assert_eq!(instr.to_bytevec(),
            &[0x00, 0x00, 0x00, 0x04, 0x40, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00,
    ...
    fn new_voltage_read() {
        ...
        assert_eq!(instr.to_bytevec(),
            &[0x00, 0x00, 0x00, 0x08, 0x40, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00,
